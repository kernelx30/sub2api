...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			OptionalInstructionsEnabled:     apiKey.Group.OptionalInstructionsEnabled,
			OptionalInstructions:            apiKey.Group.OptionalInstructions,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			OptionalInstructionsEnabled:     snapshot.Group.OptionalInstructionsEnabled,
			OptionalInstructions:            snapshot.Group.OptionalInstructions,

	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldOptionalInstructionsEnabled,
				group.FieldOptionalInstructions,
...
func (r *apiKeyRepository) Update(ctx context.Context, key *service.APIKey, fields service.APIKeyUpdateFields) error {
	...
	if fields.OpenAIAvailabilityFallbackGroupID {
	...
	if fields.OptionalInstructionsEnabled {
		builder.SetOptionalInstructionsEnabled(key.OptionalInstructionsEnabled)
	}

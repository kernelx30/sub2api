export default {
  ...
  keys: {
    ...
    groupLabel: 'Group',
	openAIAvailabilityFallbackGroup: 'Backup GPT group (optional)',
	openAIAvailabilityFallbackGroupHint: 'After the primary group has no usable account or exhausts retryable failures, continue with this user-selected second group. Leave empty to use only the primary group.',
	noOpenAIAvailabilityFallbackGroup: 'No backup group',
	optionalInstructions: 'Restriction-bypass prompt',
	optionalInstructionsHint: "Inject this group's prompt to reduce model refusal behavior and loosen moral constraints",
	optionalInstructionsUnavailable: 'The selected group has no restriction-bypass prompt configured',

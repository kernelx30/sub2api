export default {
    accounts: {
      ...
      poolRanking: {
        ...
        groupsLoadFailed: 'Failed to load account groups',
        noGroups: 'No active OpenAI account groups are available',
        enabled: 'Automatic ranking on',
        disabled: 'Automatic ranking off',
        cadence: 'Probes and re-ranks every {minutes} minutes; this page reads the cache every 60 seconds',
        group: 'Ranking group',
        loadFailed: 'Failed to load the automatic pool ranking',
        rank: 'Rank',
        account: 'Account',
        status: 'Probe Status',
        latest: 'Latest',

...
const GITHUB_REPO = 'kernelx30/sub2api'
// Fork GHCR image (tags carry no "v" prefix, e.g. ghcr.io/kernelx30/sub2api:0.1.146)
const DOCKER_IMAGE = 'ghcr.io/kernelx30/sub2api'

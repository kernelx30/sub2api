...
const flagMySubscriptions = makeSidebarFlag(FeatureFlags.mySubscriptions)
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/subscriptions', label: t('nav.mySubscriptions'), icon: CreditCardIcon, hideInSimpleMode: true, featureFlag: flagMySubscriptions },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/account-ranking', label: t('nav.accountRanking'), icon: ChartIcon },

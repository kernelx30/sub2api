...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/kernelx30/sub2api/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/kernelx30/sub2api/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/kernelx30/sub2api/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/kernelx30/sub2api/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      // My Subscriptions page switch
      my_subscriptions_enabled: form.my_subscriptions_enabled,
      // Model Plaza feature switches + description
